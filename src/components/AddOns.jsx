...
\nStep 1 – Pick up the phone.\nStep 2 – Leave your message after the beep.\nStep 3 – Hang up to save your recording.`,
  ...
  return (
    <section className="w-full pb-12 bg-muted/30">
          ...
          {addOns.map((booth, index) => (
            ...
            >
              <div className="md:w-2/5 mx-auto text-center md:text-start my-9 md:my-0">
                <h2 className="text-3xl my-4 md:text-4xl lg:text-5xl xl:text-6xl font-dhaks">{booth.title}</h2>
                <p className="font-rische font-semibold text-lg lg:text-xl xl:text-2xl leading-5 text-textCol md:w-4/5 lg:w-3/5 mb-4">
                  {booth.description}
                </p>
                <p className="font-rische font-medium text-lg lg:text-xl xl:text-2xl leading-5 text-textCol md:w-4/5 whitespace-pre-line">
                  {booth.content}
                </p>
              </div>
